...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2023 at 04:42 AM
...
INSERT INTO `candidatos` (`id`, `nombre`, `partido`, `posicion`) VALUES
(1, 'Sebastián Piñera', 'Coalición por el Cambio', 'Candidato'),
(2, 'Alejandro Guillier', 'Nueva Mayoría', 'Candidato'),
(3, 'Beatriz Sánchez', 'Frente Amplio', 'Candidata'),
(4, 'José Antonio Kast', 'Acción Republicana', 'Candidato'),
(5, 'Carolina Goic', 'Democracia Cristiana', 'Candidata');
...
INSERT INTO `comunas` (`id_comuna`, `id_region`, `name`) VALUES
(1, 1, 'Arica'),
(2, 1, 'Camarones'),
(3, 1, 'Putre'),
(4, 1, 'General Lagos'),
...
CREATE TABLE `votos` (
  ...
  `candidato_id` int(3) NOT NULL DEFAULT 0,
  `entero` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `comunas`
  MODIFY `id_comuna` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=347;
